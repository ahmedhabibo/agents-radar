...
function buildXiaohongshuPrompt(reports: string, date: string): string {
  return `أنت صانع محتوى في مجال تقنيات الذكاء الاصطناعي، أسلوبك موضوعي ومهني، وتتقن إيصال التطورات التقنية بإيجاز.

فيما يلي المحتوى الخام لنشرة الذكاء الاصطناعي اليومية بتاريخ ${date}:

${reports}

---

بناءً على المحتوى أعلاه، يُرجى إنشاء تدوينة نشرة يومية لـ Xiaohongshu، بالمتطلبات التالية:

**العنوان**: موجز وواضح، 15-25 حرفاً، يلخّص أبرز تطورات اليوم

**المتن** (500-800 كلمة):
1. جملة واحدة تلخّص ديناميكيات مجال الذكاء الاصطناعي اليوم بشكل عام
2. اختَر 5-8 نقاط جديرة بالاهتمام اليوم، كل نقطة:
   - بعنوان فرعي قصير (يمكن استخدام emoji لتمييز الفئات)
   - 1-2 جملة تُوضّح الحقيقة والأهمية
   - لغة موجزة، دون مبالغة
3. جملة ختامية تلخّص النشرة
4. أضِف في النهاية 3-5 وسموس (#AI #OpenSource إلخ)

**متطلبات الأسلوب**:
- نبرة موضوعية، كأنك تكتب نشرة تقنية، بلا ترويج أو إثارة عاطفية
- فقرات قصيرة تناسب القراءة على الهاتف
- حافِظ على المصطلحات التقنية كما هي بالإنجليزية، دون تسطيح مُفتعل
- ركّز على عرض الحقائق، قلّل من علامات التعجب والصفات المبالغة
- لا تُضِف أي روابط (Xiaohongshu لا يدعم الروابط الخارجية)

أخرِج العنوان والمتن مباشرة، دون أي إيضاح إضافي.`;
}
